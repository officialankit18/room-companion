...
export const createListingValidator = [
  ...
  body("flatNumber").trim().notEmpty().withMessage("Flat or house number is required"),
  body("building").optional().trim(),
  body("landmark").optional().trim(),
  body("displayAddress").trim().notEmpty().withMessage("Select a valid property location"),
...
export const updateListingValidator = [
  ...
  body("building").optional().trim(),
  body("landmark").optional().trim(),
  body("displayAddress").optional().trim().notEmpty(),
